        ...
        <>
            <div
                ...
                <div className="flex justify-between p-5">
                    <img src="./public/images/mobile/close-icon.svg" alt="" onClick={navbariBagla} className="cursor-pointer" />
                    <img src="./public/images/mobile/basket.svg" alt="" />
                </div>
            ...
            <header className="header px-2.5 md:px-10 py-10 flex justify-between items-center">
                ...
                <div className="mobile-section flex items-center gap-3.5 md:gap-6 lg:hidden ">
                    ...
                    <img src="./public/images/header/mobile-logo.svg" alt="" />
                </div>
                ...
                <div className="header-right-side flex gap-3.5 md:gap-6">
                    <img src="./public/images/header/user.svg" alt="" />
